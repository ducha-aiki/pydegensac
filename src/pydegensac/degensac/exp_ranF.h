...
int exp_ransacFcustomLAF(double *u, double *u_1, double *u_2,int len, double th,  double laf_coef, double conf, int max_sam,
            ...
            int * data_out, int do_lo, unsigned inlLimit, double **resids, double* H_best, int* Ih,exFDsPtr EXFDS1, FDsPtr FDS1, FDsidxPtr FDS1idx,  double SymCheck_th, int enable_degen_check, int seed_value);
